...
class Sidebarbk extends React.Component{
             ...
             <div id="header_top" className="header_top">
                    ...
                    <div className="hleft">
                        <div className="dropdown">
                            < div className="icon menu_toggle mr-3">
                                ...
                                <Link onClick = {this.UpdateViewMap} href='UserList' class="nav-link icon app_file xs-hide"><i className="fa fa-eye"  data-toggle="tooltip" data-placement="right" title="Assign Users to Projects List"></i></Link >
                ...
                <Link className="icon menu_toggle mr-3 float-right" ><i  className="fa fa-window-close "></i></Link>
                        ...
                        <ul className="metismenu" >
                            ...
                            <li><Link href="UserList"  onClick = {this.UpdateViewMap}><i className="fa fa-user"></i><span>Assign Users to Projects List</span></Link></li>
