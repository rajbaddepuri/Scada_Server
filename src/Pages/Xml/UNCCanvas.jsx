...
class UNCCanvas extends Component {
  ...
  importingXmls() {
    ...
    var images = importAll(require.context('D:/EC_SCADA_PROJECTS/ECSCADA Web Server/src/Pages/Xml/Xml', false, /\.(pagex)$/));
    // //console.log(images)
    this.setState({
      xmlsList: images
    }, () => {
  ...
  //This Loads  User Selected Xml 
   async handleSubmit(event) {
    ...
    try {
      var value = require('D:/EC_SCADA_PROJECTS/ECSCADA Web Server/src/Pages/Xml/Xml/'+ event + '.pagex');
    } catch {
    ...
    if (jsonObj.hmipage.template_id != "") {
      ...
      try {
        var value = require('D:/EC_SCADA_PROJECTS/ECSCADA Web Server/src/Pages/Xml/templates/' + jsonObj.hmipage.template_id + '.pagex');
      } catch {
...
//Code to create Buttons based on the List of Files in xml;
  // {this.state.currentXml === "Home_Page" ?
  // //Home Page----------------------------------
  // <div className="Container" style={{ width: this.state.windowwidth, height: this.state.windowheight, background: "#004C99" }}>
  //   <br />
      ...
      <div id="stageContainer" width={this.state.windowwidth}
        ...
        <Navbar bg="dark" variant="dark">
          ...
          <Nav className="mr-auto">
            ...
            {/* <Butto          n variant="primary">{this.state.ProjectId}</Button>{' '} */}
          </Nav>
          <Form inline>
